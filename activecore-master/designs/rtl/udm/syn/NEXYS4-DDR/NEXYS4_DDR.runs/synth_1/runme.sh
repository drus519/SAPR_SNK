...
HD_PWD='C:/Users/Drus/Desktop/activecore-master/designs/rtl/udm/syn/NEXYS4-DDR/NEXYS4_DDR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NEXYS4_DDR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NEXYS4_DDR.tcl
