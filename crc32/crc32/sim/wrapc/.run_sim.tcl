...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado/2019.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado/2019.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado/2019.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado/2019.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado/2019.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "make_hash.autotvin.dat"
	set constFileTvOut       "make_hash.autotvout.dat"
	set constFileHdlTvIn     "make_hash.autohdltvin.dat"
	set constFileHdlTvOut    "make_hash.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
