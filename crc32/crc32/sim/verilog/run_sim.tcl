...
if {[file isfile make_hash.autotvin.dat]} {
	file delete -force make_hash.autotvin.dat
}

if {[file isfile make_hash.autotvout.dat]} {
	file delete -force make_hash.autotvout.dat
}
